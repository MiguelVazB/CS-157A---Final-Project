...
--
-- Table structure for table `main task`
--
...
CREATE TABLE `main task` (
  ...
  KEY `TaskID` (`TaskID`),
  CONSTRAINT `Main Task_ibfk_1` FOREIGN KEY (`TaskID`) REFERENCES `task` (`TaskID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `main task`
--

LOCK TABLES `main task` WRITE;
/*!40000 ALTER TABLE `main task` DISABLE KEYS */;
INSERT INTO `main task` VALUES (1,4),(3,5),(2,6);
/*!40000 ALTER TABLE `main task` ENABLE KEYS */;
UNLOCK TABLES;
