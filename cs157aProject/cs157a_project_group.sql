...
CREATE TABLE `group` (
  ...
  CONSTRAINT `Group_ibfk_1` FOREIGN KEY (`Leader`) REFERENCES `employee` (`EmployeeID`),
  CONSTRAINT `Group_ibfk_2` FOREIGN KEY (`DepartmentTaskID`) REFERENCES `department task` (`DepartmentTaskID`)
...
INSERT INTO `group` VALUES (1,'Gardener Group',3,12345),(2,'Staff Group',6,24680),(3,'Mechanical Group',1,13579);
